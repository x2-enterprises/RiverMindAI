...
const ConfirmedContent = () => {
  ...
  useEffect(() => {
    // Trigger confetti & get window size on mount
  ...
  return (
    ...
    >
      {showConfetti && <Confetti recycle={false} numberOfPieces={300} width={windowSize.width} height={windowSize.height} />}
...
// Main page component wraps the dynamic content in Suspense
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/50 to-black text-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <Suspense fallback={
        <div className="flex justify-center items-center min-h-[60vh]">
          <p className="text-xl font-orbitron animate-pulse text-purple-300">Confirming Premium Consciousness Upgrade...</p>
        </div>
      }>
        <ConfirmedContent />
      </Suspense>
